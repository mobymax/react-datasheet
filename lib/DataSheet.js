  ...
  _createClass(DataSheet, [{
      ...
      if (offsets && (offsets.i || offsets.j)) {
        ...
        var updateLocation = function updateLocation() {
          if (data[newLocation.i] && typeof data[newLocation.i][newLocation.j] !== 'undefined') {
            ...
            var cell = _this3.props.data[newLocation.i][newLocation.j];
            if (_this3.props.enableTabEdit && !cell.readOnly) {
              ...
              if (_this3.props.ignoreFirstColumnTab && newLocation.j === 0) {
                ...
                _this3._setState({ start: newLocation, end: newLocation, editing: newLocation });
              }
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        { ref: function ref(r) {
            _this5.dgDom = r;
          }, tabIndex: '0', className: 'data-grid-container' },
...
DataSheet.propTypes = {
  ...
  forceStartEditCell: _propTypes2.default.object,
  enableTabEdit: _propTypes2.default.bool,
