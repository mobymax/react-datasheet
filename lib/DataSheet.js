...
var _clipboardPolyfill2 = _interopRequireDefault(_clipboardPolyfill);
  ...
  _createClass(DataSheet, [{
    ...
    value: function handleCopy(e) {
      if (isEmpty(this.state.editing)) {
        ...
        _clipboardPolyfill2.default.writeText(text);
      }
    }
  }, {
    key: 'handlePaste',
    value: function handlePaste(text) {
      if (isEmpty(this.state.editing)) {
    ...
    value: function handleKey(e) {
      ...
      if (ctrlKeyPressed) {
        if (keyCode === _keys.C_KEY) {
          ...
          _clipboardPolyfill2.default.readText().then(this.handlePaste);
        }
        return true;
      }
