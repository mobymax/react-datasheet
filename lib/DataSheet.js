    ...
    value: function componentDidMount() {
      ...
      if (this.isIE()) {
        window.requestAnimationFrame(function () {
          document.addEventListener('keydown', _this2.handleKey);
        });
      }
    }
  }, {
      ...
      if (offsets && (offsets.i || offsets.j)) {
        ...
        var updateLocation = function updateLocation() {
          if (data[newLocation.i] && typeof data[newLocation.i][newLocation.j] !== 'undefined') {
            _this4._setState({ start: newLocation, end: newLocation, editing: {} });
            e.preventDefault();
            return true;
          }
          return false;
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _extends({ ref: function ref(r) {
            _this6.dgDom = r;
          }, tabIndex: '0', className: 'data-grid-container' }, handler),
