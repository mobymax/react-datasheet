...
var _clipboardPolyfill = require('clipboard-polyfill');

var clipboard = _interopRequireWildcard(_clipboardPolyfill);
...
var DataSheet = function (_PureComponent) {
  ...
  function DataSheet(props) {
    ...
    _this.fireAll = function (e) {
      _this.handleComponentKey(e);

      if (_this.isIE()) {
        if (!_this.state.handleNavigate) {
          _this.handleKey(e);
        }
      } else {
        _this.handleKey(e);
    ...
    _this.scrollTo = function (newLocation) {
      var scrollHeight = _this.props.rowHeight * (newLocation.i - 1);
  ...
  _createClass(DataSheet, [{
    ...
    key: '_setState',
    value: function _setState(state, f, d) {
      if (this.isSelectionControlled() && ('start' in state || 'end' in state)) {
        ...
        this.setState(rest, f ? function () {
          return f(d);
        } : null);
      } else {
        this.setState(state, f ? function () {
          return f(d);
        } : null);
      }
    }
    ...
    key: 'handlePaste',
    value: function handlePaste(mixed) {
      if (isEmpty(this.state.editing)) {
    ...
    value: function handleKey(e) {
      ...
      if (ctrlKeyPressed) {
        ...
        if (this.isIE()) {
          if (keyCode === _keys.C_KEY) {
            this.handleCopy(e);
          } else if (keyCode === _keys.V_KEY) {
      ...
      if (offsets && (offsets.i || offsets.j)) {
        ...
        var updateLocation = function updateLocation() {
          if (data[newLocation.i] && typeof data[newLocation.i][newLocation.j] !== 'undefined') {
            ...
            if (_this3.props.ignoreFirstColumnTab && newLocation.j === 0) {
              return false;
            }
            _this3._setState({ start: newLocation, end: newLocation, editing: {} }, _this3.scrollTo, newLocation);
            e.preventDefault();
            return true;
          }
          return false;
    ...
    value: function handleComponentKey(e, f) {
      var _this4 = this;
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _extends({ ref: function ref(r) {
            _this5.dgDom = r;
          } }, tab, { className: 'data-grid-container' }),
...
DataSheet.propTypes = {
  ...
  ignoreFirstColumnTab: _propTypes2.default.bool
};
